-- =========================================================================
-- ORBIT · Esquema completo de Supabase (copia consolidada)
--
-- Este archivo une, en orden, todas las migraciones de supabase/migrations/:
--   1. 20260908000000_init_schema.sql        (catálogo, carrito, pedidos, auth)
--   2. 20260910000000_notifications_schema.sql (historial de notificaciones)
--
-- Es idempotente: se puede pegar y ejecutar entero las veces que haga falta
-- (tablas, secuencia, índices, políticas, trigger y funciones usan
-- IF NOT EXISTS / DROP...IF EXISTS / OR REPLACE) sin que falle por objetos
-- que ya existan.
--
-- Es una copia de conveniencia para pegar el esquema completo de una sola
-- vez en el SQL Editor de Supabase Studio. La fuente de verdad sigue siendo
-- supabase/migrations/*.sql — si el esquema cambia, actualiza los archivos
-- de migración primero y vuelve a regenerar este archivo a partir de ellos.
-- =========================================================================


-- =========================================================================
-- 1) supabase/migrations/20260908000000_init_schema.sql
-- =========================================================================
...
-- =========================================================================
-- 2) supabase/migrations/20260910000000_notifications_schema.sql
-- =========================================================================
