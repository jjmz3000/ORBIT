...
import { X, CheckCircle2, CreditCard, Shield, Truck, Sparkles, ArrowRight, AlertCircle } from 'lucide-react';
...
const EMPTY_ADDRESS: Address = { fullName: '', street: '', city: '', postalCode: '', phone: '' };
...
export const CheckoutModal = ({
  ...
  // Form state
  const [address, setAddress] = useState<Address>(defaultAddress ?? EMPTY_ADDRESS);
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setError(null);
      setAddress(defaultAddress ?? EMPTY_ADDRESS);
    }
  ...
  const handleSubmitOrder = async (e: FormEvent) => {
    e.preventDefault();
    if (!address.fullName || !address.street || !address.city || !address.postalCode || !address.phone) return;
          ...
          <form onSubmit={handleSubmitOrder} className="p-5 sm:p-6 space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                ...
                <div>
                  <label className="text-[11px] font-semibold text-zinc-600 block mb-1">
                    Teléfono de contacto (para avisos de reparto)
                  </label>
                  <input
                    type="tel"
                    required
          ...
          <div className="p-6 text-center space-y-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-zinc-500 max-w-xs mx-auto leading-relaxed">
                Hemos enviado la confirmación y la factura a tu correo electrónico.
              </p>
            </div>
